...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CLOSE:
        if (MessageBox(hwnd, L"Really quit?", L"Torus", MB_OKCANCEL) == IDOK)
        {
            ...
            MessageBox(hwnd, L"You are a really funny person ngl", L"Torus", MB_OKCANCEL);
        }
        return 0;
    ...
    while (GetMessage(&msg, NULL, 0, 0)) {
        ...
        if (isControlShiftAlt()) {
            if (MessageBox(hwnd, L"Really quit?", L"Torus", MB_OKCANCEL) == IDOK) {
                ...
                MessageBox(hwnd, L"You are a really funny person ngl", L"Torus", MB_OK);
            }
        }
    }
